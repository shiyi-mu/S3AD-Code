...
path.project_path = os.path.join(path.project_path, '07-A3D-for-paper-r1', "202-ped-eval-mono")
...
head_loss = edict(
    ...
    balance_weight = [20.0, 80.0], # 长度等于obj_types_kitti长度
