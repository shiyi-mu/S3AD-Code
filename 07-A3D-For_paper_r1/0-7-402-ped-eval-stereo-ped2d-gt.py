...
cfg.obj_types_fg = cfg.obj_types + ['Pedestrian', "Ood"] # for 2d fg loss only
...
path.project_path = os.path.join(path.project_path, '07-A3D-for-paper-r1', "0-7-402-ped-eval-stereo-ped2d-gt.py")
