...
path.project_path = os.path.join(path.project_path, '07-A3D-for-paper-r1', "803-ar-nums-2-10")
...
train_split_file = "smb9_msy/03-Data/02-KITTI/KITTI-OOD/id-train/ImageSets/train_2of10.txt" 
