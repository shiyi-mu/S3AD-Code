...
cfg.obj_types_kitti = ['Car', 'Cyclist', "Pedestrian", "OtherForeground"]    # train for classification loss
cfg.obj_types = cfg.obj_types_kitti # train for 3d+2d loss
cfg.obj_types_fg = cfg.obj_types + ["Ood"] # for 2d fg loss
...
path.project_path = os.path.join(path.project_path, '07-A3D-for-paper-r1', "601-ar-train-arood-val-mspf")
...
train_split_file = "smb9_msy/03-Data/02-KITTI/KITTI-OOD/id-train/ImageSets/train.txt" #GDINO
...
detector.head = edict(
    ...
    ood_score_type = "RBA" # ["MSPF", "MSPF", "RBAF"]
