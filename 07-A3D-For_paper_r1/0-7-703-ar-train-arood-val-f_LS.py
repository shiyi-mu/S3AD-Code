...
cfg.obj_types_fg = cfg.obj_types + ["Ood"] # for 2d fg loss only
...
path.project_path = os.path.join(path.project_path, '07-A3D-for-paper-r1', "703-ar-train-arood-val-f_LS")
...
detector.name = 'Stereo3DFgByLeftStereo'
