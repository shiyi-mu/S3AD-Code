...
path.workspace = "smb9_msy/02-Code/04-AD4AD/02-S3AD-public/S3AD-Code/"
...
path.project_path = os.path.join(path.project_path, '07-A3D-for-paper-r1', "811-ar-nums-10-10")
