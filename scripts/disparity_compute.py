...
def compute_dispairity_for_split(cfg,
    ...
    for i, index_name in tqdm(enumerate(index_names)):
        ...
        calib, image, right_image, label, velo, label3= data_frame.read_data()
        ...
        file_name = os.path.join(disp_dir, "P2{}.png".format(index_name))
        ...
        file_name = os.path.join(disp_dir, "P3{}.png".format(index_name))
