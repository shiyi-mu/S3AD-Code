...
class Compose(object):
    ...
    def __call__(self, left_image:np.ndarray,
                       ...
                       labels3:Union[None, List[KittiObj]]=None,
        ...
        for t in self.transforms:
            left_image, right_image, p2, p3, labels, labels3, image_gt, lidar = t(left_image, right_image, p2, p3, labels, labels3, image_gt, lidar)
        return_list = [left_image, right_image, p2, p3, labels, labels3, image_gt, lidar]
        if self.is_return_all:
            return return_list
