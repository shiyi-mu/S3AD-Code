...
class ConvertToFloat(object):
    ...
    """
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, labels3=None, image_gt=None, lidar=None):
        return left_image.astype(np.float32), right_image if right_image is None else right_image.astype(np.float32), p2, p3, labels, labels3, image_gt, lidar
...
class Normalize(object):
    ...
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, labels3=None,image_gt=None, lidar=None):
        ...
        if right_image is not None:
            ...
            right_image = right_image.astype(np.float32)
        return left_image, right_image, p2, p3, labels, labels3, image_gt, lidar
...
class Resize(object):
    ...
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, labels3=None, image_gt=None, lidar=None):
        ...
        if labels3:
            if isinstance(labels3, list):
                for obj3 in labels3:
                    obj3.bbox_l *= scale_factor_yx[1]
                    obj3.bbox_r *= scale_factor_yx[1]
                    obj3.bbox_t *= scale_factor_yx[0]
                    obj3.bbox_b *= scale_factor_yx[0]
...
@AUGMENTATION_DICT.register_module
class TransRightFov(object):
    def __init__(self, fov_ratial=0.5):
        self.fov_ratial = fov_ratial

    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, labels3=None, image_gt=None, lidar=None):
        height, width = left_image.shape[0:2]
        # 中心点不变，四周边界向内缩小fov_ratial
        if p3 is not None:
            cy = p3[1, 2] # cy
            cx = p3[0, 2] # cx
            upper = int(cy * (1 - self.fov_ratial))
            lower = int(upper + height * self.fov_ratial)
            left = int(cx * (1 - self.fov_ratial))
            right = int(left + width * self.fov_ratial)
        # print("cy: %d, cy: %d, height: %d, width: %d" % (cy, cy, height, width))
        # print("upper: %d, lower: %d, left: %d, right: %d" % (upper, lower, left, right))
        if right_image is not None:
            # crop center
            right_image = right_image[upper:lower, left:right, :]
...
class CropRight(object):
    ...
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, labels3=None, image_gt=None, lidar=None):
        ...
        if righter > width:
            ...
            return left_image, right_image, p2, p3, labels, labels3
    ...
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, labels3=None, image_gt=None, lidar=None):
        ...
        if labels3 is not None:
            ...
            if isinstance(labels3, list):
                ...
                for obj3 in labels3:
                    is_outside3 = (
                        obj3.bbox_b < 0 or obj3.bbox_t > height or obj3.bbox_r < 0 or obj3.bbox_l > width
                    )
                    if not is_outside3:
                        new_labels3.append(obj3)
        else:
            new_labels3 = None
        
        return left_image, right_image, p2, p3, new_labels, new_labels3, image_gt, lidar
...
class RandomCropToWidth(object):
    ...
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, labels3=None, image_gt=None, lidar=None):
        ...
        if self.width > original_width:
            ...
            return left_image, right_image, p2, p3, labels, labels3, image_gt
        ...
        if random.rand() <= self.mirror_prob:
            ...
            if labels3:
                if isinstance(labels3, list):
                    for obj3 in labels3:
                        # In stereo horizontal 2D boxes will be fixed later when we use 3D projection as 2D anchor box
                        obj3.bbox_l, obj3.bbox_r = left_image.shape[1] - obj3.bbox_r - 1, left_image.shape[1] - obj3.bbox_l - 1
...
class PhotometricDistort(object):
    ...
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, labels3=None, image_gt=None, lidar=None):
        ...
        return distortion(left_image.copy(), right_image if right_image is None else right_image.copy(), p2, p3, labels, labels3, image_gt, lidar)
...
class Augmentation(object):
    ...
    def __call__(self, left_image, right_image, p2=None, p3=None, labels=None, labels3=None, image_gt=None, lidar=None):
        return self.augment(left_image, right_image, p2, p3, labels, labels3, image_gt, lidar)
...
class Preprocess(object):
    ...
    def __call__(self, left_image, right_image, p2=None, p3=None, labels=None, labels3=None, image_gt=None, lidar=None):
        ...
        left_image, right_image, p2, p3, labels, labels3, image_gt, lidar = self.preprocess(left_image, 
                                                                                            right_image, p2, p3, 
                                                                                            labels, labels3,
                                                                                            image_gt, lidar)
...
class Shuffle(object):
    ...
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, labels3=None, image_gt=None, lidar=None):
        ...
        for index in shuffled_indexes:
            left_image, right_image, p2, p3, labels, labels3, image_gt, lidar = self.transforms[index](left_image, right_image, p2, p3, labels, labels3, image_gt, lidar)
